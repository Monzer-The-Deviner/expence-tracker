...
const SideBar = () => {
    return ( 
        <div className="w-full md:w-auto md:h-full flex rounded-t-xl md:rounded-none md:rounded-r-2xl p-4 shadow-xl bg-[#2C5056] justify-between flex-row md:flex-col fixed bottom-0 left-0 self-start ">

            <img src={logo} alt="profile pictue" className="rounded-full w-6 invert"  />
