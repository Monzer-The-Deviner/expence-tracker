...
const Header = ({task}) => {
    ...
    return ( 
        <div className={` bg-white shadow-xl rounded-b-lg md:w-full p-4 md:p-8 flex flex-col md:flex-row justify-between`}>
            
            <div className={`flex items-end pl-4 text-white text-5xl p-2 w-full mb-2 md:mb-0 md:mr-4 h-32 rounded-md bg-gradient-to-tr ${total>0?'from-cyan-900 to-green-600':'from-rose-950 to-red-600'}`} ><span className="text-sm self-start pt-2">your total amount:</span>
            ...
            <div className="flex flex-row md:flex-col justify-between  w-full mt-2 md:mt-0 md:ml-4 text-3xl h-12 md:h-auto text-white">
                <div className=" flex-1 mr-1 md:mr-0 md:mb-1 rounded-lg bg-red-600 justify-between pr-4 items-center flex pl-4">
                <span className="text-sm self-start pt-2">Expenses: </span>
                ...
                <span className="text-sm self-start pt-2">Incomes: </span>
