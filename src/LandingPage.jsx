...
const LandingPage = () => {
  return (
    <div className="h-[80vh] bg-gradient-to-r from-slate-800 bg-[length:300%] relative  to-slate-800 via-emerald-900 animate-gradientAnimation flex justify-center items-center w-full rounded-b-3xl flex-col gap-8">
      <header className=" w-full fixed top-0  flex justify-between py-4 gap-4  max-w-5xl px-2">
        ...
        <div className="text-5xl z-10 text-white font-bold text-center">
            Manage your finance <br/>with no headeach
            <br />
        </div>
